"""
Django settings for misty_limit_42789 project.
...
ROOT_URLCONF = 'misty_limit_42789.urls'
...
WSGI_APPLICATION = 'misty_limit_42789.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_limit_42789 API",
    "DESCRIPTION": "API documentation for misty_limit_42789 App",
    "VERSION": "v1",
}
